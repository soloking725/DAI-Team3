...
st.set_page_config(page_title="F-1 Student Visa", page_icon=FAVICON, layout="wide", initial_sidebar_state="collapsed")
...
<div class="content-card">
    ...
    <ol style="padding-left:1.5rem; margin:0.5rem 0;">
        ...
        <li style="margin-bottom:0.75rem;"><strong>Pay the SEVIS I-901 fee</strong> - Pay the $350 SEVIS fee online at fmjfee.gov and keep the receipt.</li>
