...
st.set_page_config(page_title="J-1 Exchange Visitor", page_icon=FAVICON, layout="wide")
st.markdown(get_global_css(), unsafe_allow_html=True)
st.markdown(get_vera_css(), unsafe_allow_html=True)

render_hamburger_menu(visa_type=get_vera_state().get("profile", {}).get("visa_type") or "j-1")
st.markdown(render_disclaimer(), unsafe_allow_html=True)
render_profile_banner(page_visa_type="j-1")
